...
const getColorStyles = (color: TTypographyColor, theme: DefaultTheme, brightness: TBrightness) => {
  if (color === 'base') {
...
const Typography = styled('span')<{
  ...
  color: ${({ color, theme, brightness }) => getColorStyles(color, theme, brightness)};
